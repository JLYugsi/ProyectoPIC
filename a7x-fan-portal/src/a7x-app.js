  ...
  render() {
    return html`
      <div class="container hero-section text-white">
        ...
        <img src="https://www.spirit-of-metal.com/les%20goupes/A/Avenged%20Sevenfold/pics/1523075_logo.jpg" 
          class="img-fluid rounded border border-danger shadow-lg">
        <img src="https://www.spirit-of-metal.com/les%20goupes/A/Avenged%20Sevenfold/pics/9e0a_1.jpg" 
          class="img-fluid rounded border border-danger shadow-lg">
        <div class="mt-5">
...
// --- APP PRINCIPAL (NAVBAR ACTUALIZADO) ---
  ...
  render() {
    ...
    return html`
      <nav class="navbar navbar-expand-lg navbar-dark sticky-top p-3">
        <div class="container-fluid px-5"> <a class="brand" href="/">A7X</a>
              ...
              ${user 
                ? html`
                    <div class="user-section">
                      <span class="welcome-text">Hola! <span class="username">${user.nombre}</span></span>
                      <span class="text-muted">|</span>
                      <a href="#" class="btn-logout" @click="${this._logout}">Cerrar Sesión</a>
                    </div>
                  `
                : html`
                    <a class="nav-link btn-login" href="/login">LOGIN / REGISTRO</a>
                  `
              }
            </div>
